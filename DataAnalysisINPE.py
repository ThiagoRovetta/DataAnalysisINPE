...
##plt.xlim(1,9)
##plt.ylim(340,460)
##plt.xlabel('Densidade (unidade de densidade)')
##plt.ylabel('Velocidade (unidade de velocidade)')
##plt.title('')
##plt.grid()
##
##
##plt.scatter(df['speed'], df['density'])
##plt.ylim(1,9)
##plt.xlim(340,460)
##plt.ylabel('Densidade (unidade de densidade)')
##plt.xlabel('Velocidade (unidade de velocidade)')
##plt.title('')
##plt.grid()
##
##
##plt.scatter(df['comp_bt'], df['speed'])
##plt.xlim(1,8)
##plt.ylim(340,460)
...
##
##
##plt.scatter(df['temperature'], df['speed'])
##plt.xlim(10000,210000)
##plt.ylim(340,460)
##plt.xlabel('Temperatura (unidade de temperatura)')
##plt.ylabel('Velocidade (unidade de velocidade)')
##plt.title('')
##plt.grid()
##
##
##plt.scatter(df['speed'], df['temperature'])
##plt.ylim(10000,210000)
##plt.xlim(340,460)
##plt.ylabel('Temperatura (unidade de temperatura)')
##plt.xlabel('Velocidade (unidade de velocidade)')
##plt.title('')
##plt.grid()
##
##
##plt.scatter(df['temperature'], df['density'])
...
##
##
##plt.scatter(df['density'], df['temperature'])
##plt.ylim(1000,210000)
##plt.xlim(1,9)
##plt.ylabel('Temperatura (unidade de temperatura)')
##plt.xlabel('Densidade (unidade de densidade)')
##plt.title('')
